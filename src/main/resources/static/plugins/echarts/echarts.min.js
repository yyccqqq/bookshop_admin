!function (t, e) {
    ...
    function f(t, e, n) {
        if (t && e) if (t.forEach && t.forEach === Uf) t.forEach(e, n); else if (t.length === +t.length) for (var i = 0, r = t.length; r > i; i++) e.call(n, t[i], i, t); else for (var a in t) t.hasOwnProperty(a) && e.call(n, t[a], a, t)
    }
    ...
    function $e(t, e) {
        var n = (parseFloat(t[0]) % 360 + 360) % 360 / 360, i = Xe(t[1]), r = Xe(t[2]),
    ...
    function nn(t, e, n) {
        if (e && e.length && t >= 0 && 1 >= t) {
            var i = t * (e.length - 1), r = Math.floor(i), a = Math.ceil(i), o = Ke(e[r]), s = Ke(e[a]), l = i - r,
    ...
    function cn(t, e, n, i, r) {
        var a = t.length;
        if (1 === r) for (var o = 0; a > o; o++) i[o] = un(t[o], e[o], n); else for (var s = a && t[0].length, o = 0; a > o; o++) for (var l = 0; s > l; l++) i[o][l] = un(t[o][l], e[o][l], n)
    }
    ...
    function dn(t, e, n) {
        ...
        if (i !== r) {
            var a = i > r;
            if (a) t.length = r; else for (var o = i; r > o; o++) t.push(1 === n ? e[o] : Gp.call(e[o]))
        }
    ...
    function pn(t, e, n, i, r, a, o, s, l) {
        var u = t.length;
        if (1 === l) for (var h = 0; u > h; h++) s[h] = gn(t[h], e[h], n[h], i[h], r, a, o); else for (var c = t[0].length, h = 0; u > h; h++) for (var d = 0; c > d; d++) s[h][d] = gn(t[h][d], e[h][d], n[h][d], i[h][d], r, a, o)
    }
    ...
    function _n(t, e, n, i, r, a) {
        ...
        if (u) {
            var h, c = i[0].value, f = d(c), p = !1, g = !1, v = f ? yn(i) : 0;
            i.sort(function (t, e) {
            ...
            if (a || !x) {
                ...
                var B = function (t, e) {
                    ...
                    P = n, L = e;
                    var i = m[n + 1] - m[n];
                    if (0 !== i) if (T = (e - m[n]) / i, l) if (D = y[n], C = y[0 === n ? n : n - 1], A = y[n > u - 2 ? u - 1 : n + 1], k = y[n > u - 3 ? u - 1 : n + 2], f) pn(C, D, A, k, T, T * T, T * T * T, o(t, r), v); else {
                        var a;
                        if (p) a = pn(C, D, A, k, T, T * T, T * T * T, O, 1), a = mn(O); else {
                            if (g) return hn(D, A, T);
                            a = gn(C, D, A, k, T, T * T, T * T * T)
                        }
                        s(t, r, a)
                    } else if (f) cn(y[n], y[n + 1], T, o(t, r), v); else {
                        var a;
                        if (p) cn(y[n], y[n + 1], T, O, 1), a = mn(O); else {
                            if (g) return hn(y[n], y[n + 1], T);
                            a = un(y[n], y[n + 1], T)
                        }
                        s(t, r, a)
                    }
                }, E = new Fe({target: t._target, life: h, loop: t._loop, delay: t._delay, onframe: B, ondestroy: n});
    ...
    function zn(t, e, n) {
        var i = Qf(), r = e.getWidth(), a = e.getHeight(), o = i.style;
    ...
    function Nn(t, e, n, i, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                var a = vg.get(t), o = {hostEl: n, cb: i, cbPayload: r};
    ...
    function Wn(t, e, n, i, r, a, o) {
        var s = ti(t, e, r, a, o), l = Hn(t, e);
        r && (l += r[1] + r[3]);
        var u = s.outerHeight, h = Yn(0, l, n), c = Un(0, u, i), d = new Sn(h, c, l, u);
        return d.lineHeight = s.lineHeight, d
    }

    function Xn(t, e, n, i, r, a, o, s) {
        var l = ei(t, {rich: o, truncate: s, font: e, textAlign: n, textPadding: r, textLineHeight: a}),
            u = l.outerWidth, h = l.outerHeight, c = Yn(0, u, n), d = Un(0, h, i);
    ...
    function ti(t, e, n, i, r) {
        ...
        if (n && (l += n[0] + n[2]), t && r) {
            ...
            if (null != h && l > h) t = "", o = []; else if (null != c) for (var d = Zn(c - (n ? n[1] + n[3] : 0), e, r.ellipsis, {
                minChar: r.minChar,
        ...
        for (var p = 0; p < o.length; p++) {
            for (var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
                var _ = g.tokens[y], x = _.styleName && e.rich[_.styleName] || {}, w = _.textPadding = x.textPadding,
                    b = _.font = x.font || e.font, S = _.textHeight = A(x.textHeight, Qn(b));
                ...
                if ("string" == typeof M && "%" === M.charAt(M.length - 1)) _.percentWidth = M, u.push(_), M = 0; else {
                    ...
                    null != P && M > P && (!I || D > P ? (_.text = "", _.textWidth = M = 0) : (_.text = jn(_.text, P - D, b, c.ellipsis, {minChar: c.minChar}), _.textWidth = Hn(_.text, b), M = _.textWidth + D))
                }
    ...
    function li(t, e, n, i, r, a) {
        var o, s = fi(i), l = !1, u = e.__attrCachedBy === og.PLAIN_TEXT;
        ...
        var g = p.outerHeight, v = p.lines, m = p.lineHeight, y = vi(Dg, t, i, r), _ = y.baseX, x = y.baseY,
            w = y.textAlign || "left", b = y.textVerticalAlign;
        ci(e, i, r, _, x);
        var S = Un(x, g, b), M = _, I = S;
        if (s || d) {
            var T = Hn(n, c), C = T;
            d && (C += d[1] + d[3]);
            var D = Yn(_, C, w);
        ...
        for (var A = 0; A < Tg.length; A++) {
            var k = Tg[A], P = k[0], L = k[1], O = i[P];
            l && O === o[P] || (e[L] = ag(e, L, O || k[2]))
        }
        I += m / 2;
        var B = i.textStrokeWidth, E = l ? o.textStrokeWidth : null, z = !l || B !== E,
            R = !l || z || i.textStroke !== o.textStroke, N = yi(i.textStroke, B), F = _i(i.textFill);
    ...
    function hi(t, e, n, i, r) {
        var a = n.width, o = n.outerWidth, s = n.outerHeight, l = i.textPadding, u = vi(Dg, t, i, r), h = u.baseX,
            c = u.baseY, d = u.textAlign, f = u.textVerticalAlign;
        ci(e, i, r, h, c);
        var p = Yn(h, o, d), g = Un(c, s, f), v = p, m = g;
        l && (v += l[3], m += l[0]);
        var y = v + a;
    ...
    function di(t, e, n, i, r, a, o, s) {
        ...
        var d = yi(l.textStroke || i.textStroke, p), f = _i(l.textFill || i.textFill),
    ...
    function pi(t, e, n, i, r, a, o) {
        ...
        if (mi(e, "shadowBlur", n.textBoxShadowBlur || 0), mi(e, "shadowColor", n.textBoxShadowColor || "transparent"), mi(e, "shadowOffsetX", n.textBoxShadowOffsetX || 0), mi(e, "shadowOffsetY", n.textBoxShadowOffsetY || 0), h || l && u) {
            ...
            c ? ri(e, {x: i, y: r, width: a, height: o, r: c}) : e.rect(i, r, a, o), e.closePath()
        }
        if (h) if (mi(e, "fillStyle", s), null != n.fillOpacity) {
            var d = e.globalAlpha;
        ...
        if (l && u) if (mi(e, "lineWidth", l), mi(e, "strokeStyle", u), null != n.strokeOpacity) {
            var d = e.globalAlpha;
    ...
    function vi(t, e, n, i) {
        ...
        if (i) {
            ...
            if (l instanceof Array) r = i.x + xi(l[0], i.width), a = i.y + xi(l[1], i.height); else {
    ...
    function er(t) {
        ...
        Jg(t, function (t) {
            ...
            if (tv(r)) {
                if (a.name = null != r.name ? r.name + "" : i ? i.name : nv + n, i) a.id = i.id; else if (null != r.id) a.id = r.id + ""; else {
                    var o = 0;
    ...
    function br(t, e, n, i, r, a) {
        ...
        if (yr(h) && yr(c)) if (yr(s)) a[0] = 0; else {
            var p = -l / s;
            p >= 0 && 1 >= p && (a[f++] = p)
        } else {
            var g = c * c - 4 * h * d;
            if (yr(g)) {
                ...
                var y = pv(g), _ = h * s + 1.5 * o * (-c + y), x = h * s + 1.5 * o * (-c - y);
                _ = 0 > _ ? -fv(-_, yv) : fv(_, yv), x = 0 > x ? -fv(-x, yv) : fv(x, yv);
                var p = (-s - (_ + x)) / (3 * o);
                p >= 0 && 1 >= p && (a[f++] = p)
            } else {
                var w = (2 * h * s - 3 * o * c) / (2 * pv(h * h * h)), b = Math.acos(w) / 3, S = pv(h), M = Math.cos(b),
                    p = (-s - 2 * S * M) / (3 * o), m = (-s + S * (M + mv * Math.sin(b))) / (3 * o),
    ...
    function Sr(t, e, n, i, r) {
        ...
        if (yr(o)) {
            ...
            var h = a * a - 4 * o * s;
            if (yr(h)) r[0] = -a / (2 * o); else if (h > 0) {
                var c = pv(h), u = (-a + c) / (2 * o), d = (-a - c) / (2 * o);
    ...
    function Dr(t, e, n, i, r) {
        ...
        if (yr(a)) {
            ...
            if (yr(h)) {
                ...
                var c = pv(h), u = (-o + c) / (2 * a), d = (-o - c) / (2 * a);
                u >= 0 && 1 >= u && (r[l++] = u), d >= 0 && 1 >= d && (r[l++] = d)
            }
        }
        return l
    ...
    function Br(t, e, n, i, r, a, o, s, l, u) {
        var h, c = Sr, d = xr, f = c(t, n, r, o, kv);
    ...
    function Er(t, e, n, i, r, a, o, s) {
        var l = Ar, u = Tr, h = Sv(bv(l(t, n, r), 1), 0), c = Sv(bv(l(e, i, a), 1), 0), d = u(t, n, r, h),
            f = u(e, i, a, c);
    ...
    function Yr(t, e, n, i, r, a, o, s, l, u) {
        ...
        for (var c, d, f = 0, p = -1, g = 0; h > g; g++) {
            var v = Kv[g], m = 0 === v || 1 === v ? .5 : 1, y = xr(t, n, r, o, v);
    ...
    function Ur(t, e, n, i, r, a, o, s) {
        ...
        if (u >= 0 && 1 >= u) {
            for (var h = 0, c = Tr(e, i, a, u), d = 0; l > d; d++) {
                var f = 0 === Kv[d] || 1 === Kv[d] ? .5 : 1, p = Tr(t, n, r, Kv[d]);
                o > p || (h += Kv[d] < u ? e > c ? f : -f : c > a ? f : -f)
            }
            return h
        }
        var f = 0 === Kv[0] || 1 === Kv[0] ? .5 : 1, p = Tr(t, n, r, Kv[0]);
    ...
    function Qr(t, e, n, i, r, a, o, s, l, u, h) {
        var c = l * (um / 180), d = lm(c) * (t - n) / 2 + sm(c) * (e - i) / 2,
            f = -1 * sm(c) * (t - n) / 2 + lm(c) * (e - i) / 2, p = d * d / (o * o) + f * f / (s * s);
        p > 1 && (o *= om(p), s *= om(p));
        var g = (r === a ? -1 : 1) * om((o * o * s * s - o * o * f * f - s * s * d * d) / (o * o * f * f + s * s * d * d)) || 0,
            v = g * o * f / s, m = g * -s * d / o, y = (t + n) / 2 + lm(c) * v - sm(c) * m,
            _ = (e + i) / 2 + sm(c) * v + lm(c) * m, x = dm([1, 0], [(d - v) / o, (f - m) / s]),
            w = [(d - v) / o, (f - m) / s], b = [(-1 * d - v) / o, (-1 * f - m) / s], S = dm(w, b);
    ...
    function Ga(t, e, n, i) {
        ...
        var o, s = e.ecModel, l = s && s.option.textStyle, u = Wa(e);
        if (u) {
            o = {};
    ...
    function io(t, e) {
        var n = Nm(t.x, e.x), i = Fm(t.x + t.width, e.x + e.width), r = Nm(t.y, e.y),
    ...
    function oo(t, e, n, i, r, a, o, s) {
        var l = n - t, u = i - e, h = o - r, c = s - a, d = so(h, c, l, u);
        if (lo(d)) return !1;
        var f = t - r, p = e - a, g = so(f, p, l, u) / d;
        if (0 > g || g > 1) return !1;
        var v = so(f, p, h, c) / d;
        return 0 > v || v > 1 ? !1 : !0
    }
    ...
    function ko(t, e) {
        var n, i = Ao(t), r = Math.pow(10, i), a = t / r;
    ...
    function Ho(t, e, n) {
        ...
        var i = Co(e), r = n ? "UTC" : "", a = i["get" + r + "FullYear"](), o = i["get" + r + "Month"]() + 1,
    ...
    function Uo(t, e, n) {
        n = hy(n || 0);
        var i = e.width, r = e.height, a = yo(t.left, i), o = yo(t.top, r), s = yo(t.right, i), l = yo(t.bottom, r),
            u = yo(t.width, i), h = yo(t.height, r), c = n[2] + n[0], d = n[1] + n[3], f = t.aspect;
    ...
    function ns(t) {
        var e = t.option, n = e.data, i = I(n) ? Oy : Dy, r = !1, a = e.seriesLayoutBy, o = e.sourceHeader,
            s = e.dimensions, l = us(t);
        if (l) {
            var u = l.option;
    ...
    function is(t, e, n, i, r) {
        if (!t) return {dimensionsDefine: rs(r)};
        var a, o;
        if (e === Ay) "auto" === i || null == i ? as(function (t) {
            null != t && "-" !== t && (b(t) ? null == o && (o = 1) : o = 0)
        }, n, t, 10) : o = i ? 1 : 0, r || 1 !== o || (r = [], as(function (t, e) {
            r[e] = null != t ? t : ""
        }, n, t)), a = r ? r.length : n === Ey ? t.length : t[0] ? t[0].length : null; else if (e === ky) r || (r = os(t)); else if (e === Py) r || (r = [], f(t, function (t, e) {
            r.push(e)
        })); else if (e === Dy) {
            var s = Qi(t[0]);
            a = x(s) && s.length || 1
        }
        return {startIndex: o, dimensionsDefine: rs(r), dimensionsDetectCount: a}
    }
    ...
    function as(t, e, n, i) {
        if (null == i && (i = 1 / 0), e === Ey) for (var r = 0; r < n.length && i > r; r++) t(n[r] ? n[r][0] : null, r); else for (var a = n[0] || [], r = 0; r < a.length && i > r; r++) t(a[r], r)
    }
    ...
    function ss(t, e, n) {
        ...
        var a = {}, o = us(e);
        if (!o || !t) return a;
        var s, l, u = [], h = [], c = e.ecModel, d = Ry(c).datasetMap, p = o.uid + "_" + n.seriesLayoutBy;
    ...
    function cs(t, e, n, i, r, a) {
        ...
        } else if (e === Dy) for (var f = 0; f < t.length && l > f; f++) {
            var g = t[f], v = Qi(g);
    ...
    function ps(t) {
        t = t, this.option = {}, this.option[Ny] = 1, this._componentsMap = N({series: []}), this._seriesIndices, this._seriesIndicesMap, fs(t, this._theme.option), r(t, Iy, !1), this.mergeOption(t)
    }
    ...
    function ks(t, e) {
        var n = jy(t) && t[e], i = jy(n) && n.textStyle;
        if (i) for (var r = 0, a = iv.length; a > r; r++) {
            var e = iv[r];
    ...
    function Ls(t) {
        if (jy(t)) {
            ...
            if ("graph" === t.type) {
                ...
                if (a && !I(a)) for (var o = 0; o < a.length; o++) Ps(a[o]);
                f(t.categories, function (t) {
                    As(t)
                })
            }
            if (r && !I(r)) for (var o = 0; o < r.length; o++) Ps(r[o]);
            var e = t.markPoint;
            if (e && e.data) for (var s = e.data, o = 0; o < s.length; o++) Ps(s[o]);
            var n = t.markLine;
            if (n && n.data) for (var l = n.data, o = 0; o < l.length; o++) x(l[o]) ? (Ps(l[o][0]), Ps(l[o][1])) : Ps(l[o]);
    ...
    function sl(t, e, n) {
        if (t && (t.trigger(e, n), t.isGroup && !za(t))) for (var i = 0, r = t.childCount(); r > i; i++) sl(t.childAt(i), e, n)
    }

    function ll(t, e, n) {
        var i = rr(t, e), r = e && null != e.highlightKey ? Ra(e.highlightKey) : null;
    ...
    function hl(t) {
        var e = t.model, n = t.ecModel, i = t.api, r = t.payload, a = e.pipelineContext.progressiveRender, o = t.view,
            s = r && p_(r).updateMethod, l = a ? "incrementalPrepareRender" : s && o[s] ? s : "render";
    ...
    function gl(t, e, n, i, r) {
        function a(n) {
            var a = n.uid, s = o.get(a) || o.set(a, js({plan: wl, reset: bl, count: Ml}));
            s.context = {
                model: n,
                ecModel: i,
                api: r,
    ...
    function vl(t, e, n, i, r) {
        function a(e) {
            ...
            i || (i = s.set(n, js({reset: yl, onDirty: xl})), o.dirty()), i.context = {
                model: e,
                overallProgress: h,
                modifyOutputEnd: c
        ...
        var o = n.overallTask = n.overallTask || js({reset: ml});
    ...
    function Ol(t, e, n, i) {
        ...
        if (1 === t.nodeType && (El(t, e), o(r, zl(t)), !i)) for (var s in G_) if (G_.hasOwnProperty(s)) {
    ...
    function Yl(t, e) {
        var n = t.type, i = t.escapeConnect, r = bx[n], a = r.actionInfo, l = (a.update || "update").split(":"),
            u = l.pop();
    ...
    function Zl(t, e, n, i) {
        function r(t) {
            ...
            if (!r) {
                var h = J_(t.type), c = a ? c_.getClass(h.main, h.sub) : ol.getClass(h.sub);
    ...
    function mu(t, e, n) {
        ...
        var i = Q_(t) ? t.type : [t, t = {event: e}][0];
    ...
    function Gu(t, e, n, i, r) {
        var a = Gx[e.type], o = i - 1, s = e.name, l = t[s][o];
        if (l && l.length < n) {
    ...
    function Zu(t, e) {
        var n = t.dimensions, i = new jx(p(n, t.getDimensionInfo, t), t.hostModel);
        Hu(i, t);
    ...
    function Qu(t, e, n) {
        ...
        for (var a = (n.dimsDef || []).slice(), l = N(), u = N(), h = [], c = Ju(e, t, a, n.dimCount), d = 0; c > d; d++) {
            var p = a[d] = o({}, S(a[d]) ? a[d] : {name: a[d]}), g = p.name, v = h[d] = new Nu;
        ...
        for (var M = _ || "value", I = 0; c > I; I++) {
            var v = h[I] = h[I] || new Nu, T = v.coordDim;
    ...
    function nh(t) {
        var e = t.get("coordinateSystem"), n = new eh(e), i = Qx[e];
    ...
    function sh(t, e, n) {
        ...
        var i, r = e.get("coordinateSystem"), a = xs.get(r), o = nh(e);
    ...
    function ph(t, e, n, i) {
        var r = {}, a = t[1] - t[0], o = r.interval = ko(a / e, !0);
    ...
    function bh(t) {
        var e = wh(t), n = [];
        return f(t, function (t) {
            var i, r = t.coordinateSystem, a = r.getBaseAxis(), o = a.getExtent();
            ...
            var f = yo(t.get("barWidth"), i), p = yo(t.get("barMaxWidth"), i), g = yo(t.get("barMinWidth") || 1, i),
    ...
    function Sh(t) {
        ...
        return f(e, function (t, e) {
            n[e] = {};
            var i = t.stacks, r = t.bandWidth, a = yo(t.categoryGap, r), o = yo(t.gap, 1), s = t.remainedWidth,
    ...
    function Ih(t, e) {
        var n = xh(t, e), i = bh(n), r = {};
        f(n, function (t) {
            var e = t.getData(), n = t.coordinateSystem, a = n.getBaseAxis(), o = yh(t), s = i[_h(a)][o], l = s.offset,
    ...
    function Ph(t, e, n, i) {
        var r = n.axis.getExtent(), a = r[1] - r[0], o = Mh(i, n.axis);
    ...
    function Lh(t, e) {
        var n = kh(t, e), i = null != e.getMin(), r = null != e.getMax(), a = e.get("splitNumber");
    ...
    function Rh(t) {
        ...
        if (e.get("axisLabel.show") && !n.isBlank()) {
            ...
            var s, l = t.getLabelModel(), u = Eh(t), h = 1;
            r > 40 && (h = Math.ceil(r / 40));
            for (var c = 0; r > c; c += h) {
                var d = i ? i[c] : o[0] + c, f = u(d), p = l.getTextRect(f), g = Nh(p, l.get("rotate") || 0);
                s ? s.union(g) : s = g
            }
            return s
        }
    ...
    function Nh(t, e) {
        var n = e * Math.PI / 180, i = t.plain(), r = i.width, a = i.height, o = r * Math.cos(n) + a * Math.sin(n),
            s = r * Math.sin(n) + a * Math.cos(n), l = new Sn(i.x, i.y, o, s);
        return l
    }
    ...
    function Zh(t) {
        ...
        for (var n = t.features, i = 0; i < n.length; i++) for (var r = n[i], a = r.geometry, o = a.coordinates, s = a.encodeOffsets, l = 0; l < o.length; l++) {
            var u = o[l];
            if ("Polygon" === a.type) o[l] = Kh(u, s[l], e); else if ("MultiPolygon" === a.type) for (var h = 0; h < u.length; h++) {
                var c = u[h];
                u[h] = Kh(c, s[l][h], e)
            }
        }
    ...
    function Qh(t, e) {
        return "category" === t.type ? ec(t, e) : {ticks: t.scale.getTicks()}
    }

    function Jh(t) {
        var e = t.getLabelModel(), n = tc(t, e);
        return !e.get("show") || t.scale.isBlank() ? {labels: [], labelCategoryInterval: n.labelCategoryInterval} : n
    }

    function tc(t, e) {
        var n = ic(t, "labels"), i = Fh(e), r = rc(n, i);
        if (r) return r;
        var a, o;
    ...
    function ec(t, e) {
        var n = ic(t, "ticks"), i = Fh(e), r = rc(n, i);
        if (r) return r;
        var a, o;
        if ((!e.get("show") || t.scale.isBlank()) && (a = []), w(i)) a = hc(t, i, !0); else if ("auto" === i) {
            var s = tc(t, t.getLabelModel());
            o = s.labelCategoryInterval, a = p(s.labels, function (t) {
                return t.tickValue
            })
        } else o = i, a = uc(t, o, !0);
        return ac(n, i, {ticks: a, tickCategoryInterval: o})
    }

    function nc(t) {
        var e = t.scale.getTicks(), n = Eh(t);
        return {
    ...
    function sc(t) {
        var e = lc(t), n = Eh(t), i = (e.axisRotate - e.labelRotate) / 180 * Math.PI, r = t.scale, a = r.getExtent(),
            o = r.count();
        ...
        for (var l = a[0], u = t.dataToCoord(l + 1) - t.dataToCoord(l), h = Math.abs(u * Math.cos(i)), c = Math.abs(u * Math.sin(i)), d = 0, f = 0; l <= a[1]; l += s) {
            var p = 0, g = 0, v = Gn(n(l), e.font, "center", "top");
            p = 1.3 * v.width, g = 1.3 * v.height, d = Math.max(d, p, 7), f = Math.max(f, g, 7)
        }
        var m = d / h, y = f / c;
        isNaN(m) && (m = 1 / 0), isNaN(y) && (y = 1 / 0);
        var _ = Math.max(0, Math.floor(Math.min(m, y))), x = Hw(t.model), w = t.getExtent(), b = x.lastAutoInterval,
            S = x.lastTickCount;
    ...
    function uc(t, e, n) {
        ...
        var r = Eh(t), a = t.scale, o = a.getExtent(), s = t.getLabelModel(), l = [], u = Math.max((e || 0) + 1, 1),
            h = o[0], c = a.count();
    ...
    function yc(t, e, n, i) {
        ...
        if (l) {
            if (null != u) _c(o[u]) && (a = o[u]); else for (var h in o) if (o.hasOwnProperty(h) && _c(o[h]) && !i[r(o[h])]) {
                a = o[h];
                break
            }
            a && (i[r(a)] = !0)
    ...
    function Tc(t, e, n) {
        ...
        a -= u / 2, o -= u / 2, s += u, l += u;
        var h = new Cm({shape: {x: a, y: o, width: s, height: l}});
        return e && (h.shape[r ? "width" : "height"] = 0, $a(h, {shape: {width: s, height: l}}, n)), h
    }

    function Cc(t, e, n) {
        var i = t.getArea(), r = new _m({
            shape: {
                cx: _o(t.cx, 1),
                cy: _o(t.cy, 1),
                r0: _o(i.r0, 1),
    ...
    function kc(t, e, n) {
        n.style.text = null, Ka(n, {shape: {width: 0}}, e, t, function () {
            n.parent && n.parent.remove(n)
        })
    }

    function Pc(t, e, n) {
        n.style.text = null, Ka(n, {shape: {r: n.shape.r0}}, e, t, function () {
            n.parent && n.parent.remove(n)
        })
    }
    ...
    function Oc(t, e, n, i, r, a, o, l) {
        var u = e.getItemVisual(n, "color"), h = e.getItemVisual(n, "opacity"), c = e.getVisual("borderColor"),
            d = i.getModel("itemStyle"), f = i.getModel("emphasis.itemStyle").getBarItemStyle();
    ...
    function Xc(t, e, n) {
        ...
        if (r.get("show") && !i.scale.isBlank()) {
            for (var a = r.getModel("lineStyle"), o = n.tickDirection * r.get("length"), l = i.getTicksCoords(), u = Wc(l, t._transform, o, s(a.getLineStyle(), {stroke: e.get("axisLine.lineStyle.color")}), "ticks"), h = 0; h < u.length; h++) t.group.add(u[h]);
            return u
        }
    }
    ...
    function Yc(t, e, n) {
        ...
        if (r.get("show") && !i.scale.isBlank()) {
            ...
            if (a.length) for (var o = r.getModel("lineStyle"), l = n.tickDirection * r.get("length"), u = s(o.getLineStyle(), s(e.getModel("axisTick").getLineStyle(), {stroke: e.get("axisLine.lineStyle.color")})), h = 0; h < a.length; h++) for (var c = Wc(a[h], t._transform, l, u, "minorticks_" + h), d = 0; d < c.length; d++) t.group.add(c[d])
        }
    }
    ...
    function Uc(t, e, n) {
        ...
        if (r && !i.scale.isBlank()) {
            var a = e.getModel("axisLabel"), o = a.get("margin"), s = i.getViewLabels(),
                l = (D(n.labelRotate, a.get("rotate")) || 0) * vb / 180, u = xb(n.rotation, l, n.labelDirection),
                h = e.getCategories && e.getCategories(!0), c = [], d = wb(e), p = e.get("triggerEvent");
            return f(s, function (r, s) {
                ...
                var m = v.getTextColor() || e.get("axisLine.lineStyle.color"), y = i.dataToCoord(l),
                    ...
                    x = new gm({anid: "label_" + l, position: _, rotation: u.rotation, silent: d, z2: 10});
                Va(x.style, v, {
                    text: f,
        ...
        bb(n.getCoordinateSystems(), function (n) {
            function s(i, s, l) {
                ...
                if (d && ("auto" !== d || i || nd(h))) {
                    ...
                    var f = h.get("snap"), p = id(l.model), g = s || f || "category" === l.type, v = t.axesInfo[p] = {
                        key: p,
                        axis: l,
                        coordSys: n,
                        axisPointerModel: h,
            ...
            if (n.axisPointerEnabled) {
                var l = id(n.model), u = t.coordSysAxesInfo[l] = {};
                t.coordSysMap[l] = n;
    ...
    function gd(t, e, n) {
        var i, r = t.getBaseAxis(), a = t.getOtherAxis(r), o = vd(a, n), s = r.dim, l = a.dim, u = e.mapDimension(l),
    ...
    function bd(t, e, n, i, r, a, o, s, l, u, h) {
        for (var c = 0, d = n, f = 0; i > f; f++) {
            ...
            if (d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Vb(Gb, p); else if (l > 0) {
                var g = d + a, v = e[g];
                if (h) for (; v && _d(e[g]);) g += a, v = e[g];
                var m = .5, y = e[c], v = e[g];
                if (!v || _d(v)) Vb(Wb, p); else {
                    _d(v) && !h && (v = p), q(Hb, v, y);
                    var _, x;
                    if ("x" === u || "y" === u) {
                        var w = "x" === u ? 0 : 1;
    ...
    function kd(t, e) {
        ...
        isNaN(i) && (i = 0);
        for (var r = e.count(), a = Math.max(1, Math.round(r / 5)), o = 0; r > o; o += a) if (1.5 * sd.getSymbolSize(e, o)[t.isHorizontal() ? 1 : 0] > i) return !1;
        return !0
    }

    function Pd(t, e, n) {
        if ("cartesian2d" === t.type) {
            var i = t.getBaseAxis().isHorizontal(), r = Tc(t, e, n);
            if (!n.get("clip", !0)) {
    ...
    function Ed(t, e) {
        tg.call(this);
        var n = new _m({z2: 2}), i = new Mm, r = new gm;
    ...
    function Fd(t, e) {
        return Uo(t.getBoxLayoutParams(), {width: e.getWidth(), height: e.getHeight()})
    }
    ...
    function Wd(t, e, n, i) {
        Yd(t, e, n, i), n.dispatchAction({type: "legendToggleSelect", name: null != t ? t : e}), Xd(t, e, n, i)
    }
    ...
    function Ud(t, e, n) {
        ...
        r[i.index] = 0, qo(e, n, {type: "box", ignoreSize: r})
    }
    ...
    function qd(t, e, n, i, r) {
        ...
        if (!a.scale.isBlank() && a.containData(e)) {
            ...
            var s = jd(e, t), l = s.payloadBatch, u = s.snapToValue;
    ...
    function Kd(t, e, n, i) {
        ...
        if (e.triggerTooltip && r.length) {
            var l = e.coordSys.model, u = id(l), h = t.map[u];
            h || (h = t.map[u] = {
                coordSysId: l.id,
    ...
    function Qd(t, e, n, i) {
        if (nf(e) || !t.list.length) return void i({type: "hideTip"});
    ...
    function hf(t, e) {
        if (!Hf.node) {
            var n = e.getZr(), i = (CS(n).records || {})[t];
    ...
    function yf(t, e, n, i, r) {
        var a = n.get("value"), o = xf(a, e.axis, e.ecModel, n.get("seriesDataIndices"), {
            ...
            }), s = n.getModel("label"), l = hy(s.get("padding") || 0), u = s.getFont(), h = Gn(o, u), c = r.position,
    ...
    function xf(t, e, n, i, r) {
        ...
        if (o) {
            var s = {value: zh(e, t), axisDimension: e.dim, axisIndex: e.index, seriesData: []};
            f(i, function (t) {
    ...
    function Af(t) {
        ...
        return n && e.push(Cf(n)), i && (Hf.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + tn(i)), e.push("filter:alpha(opacity=70)"))), ES(["width", "color", "radius"], function (n) {
            var i = "border-" + n, r = zS(i), a = t.get(r);
    ...
    function Lf(t) {
        for (var e = t.pop(); t.length;) {
            var n = t.pop();
            n && (uo.isInstance(n) && (n = n.get("tooltip", !0)), "string" == typeof n && (n = {formatter: n}), e = new uo(n, e, e.ecModel))
        }
        return e
    }
    ...
    var Hf = Vf, Gf = {
        ...
        }, Xf = Object.prototype.toString, Yf = Array.prototype, Uf = Yf.forEach, qf = Yf.filter, jf = Yf.slice,
        Zf = Yf.map, Kf = Yf.reduce, $f = {}, Qf = function () {
    ...
    var ep = (Object.freeze || Object)({
            ...
            concatArray: F,
            noop: V
        }), np = "undefined" == typeof Float32Array ? Array : Float32Array, ip = j, rp = Z, ap = ee, op = ne,
    ...
    var lp = Array.prototype.slice, up = function (t) {
        this._$handlers = {}, this._$eventProcessor = t
    };
    up.prototype = {
        constructor: up, one: function (t, e, n, i) {
    ...
    var hp = Math.log(2), cp = "undefined" != typeof window && !!window.addEventListener,
        dp = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, fp = "___zrEVENTSAVED", pp = [], gp = cp ? function (t) {
    ...
    vp.prototype = {
        constructor: vp, recognize: function (t, e, n) {
    ...
    xp.prototype = {
        constructor: xp, setHandlerProxy: function (t) {
            this.proxy && this.proxy.dispose(), t && (f(_p, function (e) {
                t.on && t.on(e, this[e], this)
            }, this), t.handler = this), this.proxy = t
        }, mousemove: function (t) {
            var e = t.zrX, n = t.zrY, i = De(this, e, n), r = this._hovered, a = r.target;
        ...
        xp.prototype[t] = function (e) {
            var n, i, r = e.zrX, a = e.zrY, o = De(this, r, a);
    ...
    var wp = "undefined" == typeof Float32Array ? Array : Float32Array, bp = (Object.freeze || Object)({
        create: Ae,
        identity: ke,
        copy: Pe,
        mul: Le,
    ...
    Tp.updateTransform = function () {
        ...
        if (null != r && 1 !== r) {
            ...
            var a = Cp[0] < 0 ? -1 : 1, o = Cp[1] < 0 ? -1 : 1, s = ((Cp[0] - a) * r + a) / Cp[0] || 0,
                l = ((Cp[1] - o) * r + o) / Cp[1] || 0;
    ...
    Fe.prototype = {
        constructor: Fe, step: function (t, e) {
            ...
            if (!(0 > n)) {
                n = Math.min(n, 1);
                var i = this.easing, r = "string" == typeof i ? kp[i] : i, a = "function" == typeof r ? r(n) : n;
    ...
    }, Rp = new Bp(20), Np = null, Fp = en, Vp = nn, Hp = (Object.freeze || Object)({
        parse: Ke,
        lift: Je,
        toHex: tn,
        fastLerp: en,
        ...
        when: function (t, e) {
            ...
            for (var i in e) if (e.hasOwnProperty(i)) {
                if (!n[i]) {
                    ...
                    if (null == r) continue;
                    0 !== t && n[i].push({time: 0, value: vn(r)})
                }
    ...
    var Yp = 0, Up = Xp, qp = function () {
    };
    1 === Yp && (qp = console.error);
    var jp = qp, Zp = function () {
        this.animators = []
    };
    Zp.prototype = {
        constructor: Zp, animate: function (t, e) {
    ...
    var $p = ae, Qp = Math.min, Jp = Math.max;
    Sn.prototype = {
        constructor: Sn, union: function (t) {
            ...
            return function (r) {
                if (r) {
                    ...
                    var a = Jp(t[0], e[0], n[0], i[0]), o = Jp(t[1], e[1], n[1], i[1]);
                    this.width = a - this.x, this.height = o - this.y
                }
            }
        }(), calculateTransform: function (t) {
            var e = this, n = t.width / e.width, i = t.height / e.height, r = Ae();
    ...
    tg.prototype = {
        constructor: tg, isGroup: !0, type: "group", silent: !1, children: function () {
    ...
    var eg = 32, ng = 7, ig = function () {
        this._roots = [], this._displayList = [], this._displayListLen = 0
    };
    ig.prototype = {
        constructor: ig, traverse: function (t, e) {
    ...
    var rg = {
        ...
        }, og = {NONE: 0, STYLE_BIND: 1, PLAIN_TEXT: 2}, sg = 9,
        lg = [["shadowBlur", 0], ["shadowOffsetX", 0], ["shadowOffsetY", 0], ["shadowColor", "#000"], ["lineCap", "butt"], ["lineJoin", "miter"], ["miterLimit", 10]],
        ug = function (t) {
            this.extendFrom(t, !1)
        };
    ug.prototype = {
        ...
        blend: null,
        bind: function (t, e, n) {
            var i = this, r = n && n.style, a = !r || t.__attrCachedBy !== og.STYLE_BIND;
    ...
    var gg = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function (t) {
            setTimeout(t, 16)
        }, vg = new Bp(50), mg = {}, yg = 0, _g = 5e3, xg = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, wg = "12px sans-serif",
        bg = {};
    bg.measureText = function (t, e) {
        var n = l();
        return n.font = e || wg, n.measureText(t)
    };
    var Sg = wg, Mg = {left: 1, right: 1, center: 1}, Ig = {top: 1, bottom: 1, middle: 1},
        Tg = [["textShadowBlur", "shadowBlur", 0], ["textShadowOffsetX", "shadowOffsetX", 0], ["textShadowOffsetY", "shadowOffsetY", 0], ["textShadowColor", "shadowColor", "transparent"]],
        Cg = {}, Dg = {}, Ag = new Sn, kg = function () {
        };
    kg.prototype = {
        constructor: kg, drawRectText: function (t, e) {
            var n = this.style;
        ...
        constructor: Mi, type: "image", brush: function (t, e) {
    ...
    var Pg = 1e5, Lg = 314159, Og = .01, Bg = .001, Eg = new Sn(0, 0, 0, 0), zg = new Sn(0, 0, 0, 0),
        Rg = function (t, e, n) {
            this.type = "canvas";
    ...
    Rg.prototype = {
        constructor: Rg, getType: function () {
            return "canvas"
            ...
            var t = this.getLayer(Lg).ctx, e = this._domRoot.width, n = this._domRoot.height;
            ...
            var m = Mi, y = new m({style: {x: 0, y: 0, image: n}});
    ...
    var Ng = function (t) {
        ...
        }, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, up.call(this)
    };
    Ng.prototype = {
        constructor: Ng, addClip: function (t) {
            this._clips.push(t)
    ...
    var Fg = 300, Vg = Hf.domSupported, Hg = function () {
        var t = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
            e = ["touchstart", "touchend", "touchmove"],
            n = {pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1}, i = p(t, function (t) {
                var e = t.replace("mouse", "pointer");
                return n.hasOwnProperty(e) ? e : t
            });
        return {mouse: t, touch: e, pointer: i}
    }(), Gg = {mouse: ["mousemove", "mouseup"], pointer: ["pointermove", "pointerup"]}, Wg = Ri.prototype;
    ...
    var qg = !Hf.canvasSupported, jg = {canvas: Rg}, Zg = {}, Kg = "4.2.0", $g = function (t, e, n) {
        n = n || {}, this.dom = e, this.id = t;
        var i = this, r = new ig, a = n.renderer;
        if (qg) {
        ...
        this.handler = new xp(r, o, s, o.root), this.animation = new Ng({stage: {update: y(this.flush, this)}}), this.animation.start(), this._needsRefresh;
    ...
    var Qg = (Object.freeze || Object)({version: Kg, init: Yi, dispose: Ui, getInstance: qi, registerPainter: ji}),
        Jg = f, tv = S, ev = x, nv = "series\x00",
        ...
        rv = 0, av = ".", ov = "___EC__COMPONENT__CONTAINER___", sv = 0, lv = function (t) {
        ...
        uv = lv([["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]),
        hv = {
        ...
        cv = lv([["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]]),
        dv = {
            getAreaStyle: function (t, e) {
                return cv(this, t, e)
            }
        }, fv = Math.pow, pv = Math.sqrt, gv = 1e-8, vv = 1e-4, mv = pv(3), yv = 1 / 3, _v = H(), xv = H(), wv = H(),
        bv = Math.min, Sv = Math.max, Mv = Math.sin, Iv = Math.cos, Tv = 2 * Math.PI, Cv = H(), Dv = H(), Av = H(),
        kv = [], Pv = [], Lv = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, Ov = [], Bv = [], Ev = [], zv = [],
        Rv = Math.min, Nv = Math.max, Fv = Math.cos, Vv = Math.sin, Hv = Math.sqrt, Gv = Math.abs,
        Wv = "undefined" != typeof Float32Array, Xv = function (t) {
    ...
    Xv.prototype = {
        ...
        _dashedLineTo: function (t, e) {
            var n, i, r = this._dashSum, a = this._dashOffset, o = this._lineDash, s = this._ctx, l = this._xi,
                u = this._yi, h = t - l, c = e - u, d = Hv(h * h + c * c), f = l, p = u, g = o.length;
        ...
        _dashedBezierTo: function (t, e, n, i, r, a) {
            var o, s, l, u, h, c = this._dashSum, d = this._dashOffset, f = this._lineDash, p = this._ctx, g = this._xi,
                v = this._yi, m = xr, y = 0, _ = this._dashIdx, x = f.length, w = 0;
    ...
    var Yv = 2 * Math.PI, Uv = 2 * Math.PI, qv = Xv.CMD, jv = 2 * Math.PI, Zv = 1e-4, Kv = [-1, -1, -1], $v = [-1, -1],
        Qv = fg.prototype.getCanvasPattern, Jv = Math.abs, tm = new Xv(!0);
    $r.prototype = {
        constructor: $r,
        type: "path",
        __dirtyPath: !0,
        ...
        subPixelOptimize: !1,
        brush: function (t, e) {
            var n = this.style, i = this.path || tm, r = n.hasStroke(), a = n.hasFill(), o = n.fill, s = n.stroke,
    ...
    var em = Xv.CMD, nm = [[], [], []], im = Math.sqrt, rm = Math.atan2, am = function (t, e) {
        var n, i, r, a, o, s, l = t.data, u = em.M, h = em.C, c = em.L, d = em.R, f = em.A, p = em.Q;
        for (r = 0, a = 0; r < l.length;) {
            switch (n = l[r++], a = r, i = 0, n) {
                ...
                case p:
                    ...
                    break;
                case f:
                    var g = e[4], v = e[5], m = im(e[0] * e[0] + e[1] * e[1]), y = im(e[2] * e[2] + e[3] * e[3]),
                        _ = rm(-e[1] / y, e[0] / m);
    ...
    }, om = Math.sqrt, sm = Math.sin, lm = Math.cos, um = Math.PI, hm = function (t) {
        return Math.sqrt(t[0] * t[0] + t[1] * t[1])
    }, cm = function (t, e) {
        return (t[0] * e[0] + t[1] * e[1]) / (hm(t) * hm(e))
    }, dm = function (t, e) {
        return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(cm(t, e))
    }, fm = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi, pm = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g, gm = function (t) {
        Si.call(this, t)
    };
    gm.prototype = {
        constructor: gm, type: "text", brush: function (t, e) {
            var n = this.style;
    ...
    var vm = $r.extend({
        ...
        }), mm = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]],
        ym = function (t) {
            return Hf.browser.ie && Hf.browser.version >= 11 ? function () {
                ...
                if (t.apply(this, arguments), e) for (var l = 0; l < mm.length; l++) i[mm[l][0]] = mm[l][2]
            } : t
        }, _m = $r.extend({
            type: "sector",
    ...
    Bm.prototype = {
        constructor: Bm, addColorStop: function (t, e) {
    ...
    Em.prototype = {constructor: Em}, h(Em, Bm);
    ...
    zm.prototype = {constructor: zm}, h(zm, Bm), ha.prototype.incremental = !0, ha.prototype.clearDisplaybles = function () {
    ...
    var Nm = Math.max, Fm = Math.min, Vm = {}, Hm = 1,
        Gm = {color: "textFill", textBorderColor: "textStroke", textBorderWidth: "textStrokeWidth"}, Wm = "emphasis",
        Xm = "normal", Ym = 1, Um = {}, qm = {}, jm = ia, Zm = la, Km = N(), $m = 0;
    ...
    var Qm = (Object.freeze || Object)({
        ...
        ey = lv([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["textPosition"], ["textAlign"]]),
        ny = {
            getItemStyle: function (t, e) {
                var n = ey(this, t, e), i = this.getBorderLineDash();
    ...
    uo.prototype = {
        constructor: uo, init: null, mergeOption: function (t) {
            r(this.option, t, !0)
        }, get: function (t, e) {
            return null == t ? this.option : ho(this.option, this.parsePath(t), !e && co(this, t))
        }, getShallow: function (t, e) {
            var n = this.option, i = null == n ? n : n[t], r = !e && co(this, t);
    ...
    var ay = 0, oy = 1e-4, sy = 9007199254740991,
        ...
        fy = ["a", "b", "c", "d", "e", "f", "g"], py = function (t, e) {
            ...
            getTextRect: Xo
        }), my = f, yy = ["left", "right", "top", "bottom", "width", "height"],
        _y = [["width", "left", "right"], ["height", "top", "bottom"]], xy = Yo,
        wy = (_(Yo, "vertical"), _(Yo, "horizontal"), {
            ...
            mergeDefaultAndTheme: function (t, e) {
                var n = this.layoutMode, i = n ? jo(t) : {}, a = e.getTheme();
    ...
    mr(Sy, {registerWhenExtend: !0}), po(Sy), go(Sy, Ko), c(Sy, wy);
    var My = "";
    ...
    var Iy = {
            ...
            clearColorPalette: function () {
                ...
                e = e || this;
                var i = Ty(e), r = i.colorIdx || 0, a = i.colorNameMap = i.colorNameMap || {};
                if (a.hasOwnProperty(t)) return a[t];
                var o = Ki(this.get("color", !0)), s = this.get("colorLayer", !0), l = null != n && s ? $o(s, n) : o;
                if (l = l || o, l && l.length) {
                    var u = l[r];
                    return t && (a[t] = u), i.colorIdx = (r + 1) % l.length, u
                }
            }
        }, Dy = "original", Ay = "arrayRows", ky = "objectRows", Py = "keyedColumns", Ly = "unknown", Oy = "typedArray",
        By = "column", Ey = "row";
    Qo.seriesDataToSource = function (t) {
        return new Qo({data: t, sourceFormat: I(t) ? Oy : Dy, fromDataset: !1})
    }, pr(Qo);
    var zy = {Must: 1, Might: 2, Not: 3}, Ry = ar(), Ny = "\x00_ec_inner", Fy = uo.extend({
    ...
    var Vy = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on", "off", "getDataURL", "getConnectedDataURL", "getModel", "getOption", "getViewOfComponentModel", "getViewOfSeriesModel"],
        Hy = {};
    xs.prototype = {
        constructor: xs, create: function (t, e) {
            var n = [];
            f(Hy, function (i) {
                var r = i.create(t, e);
                n = n.concat(r || [])
    ...
    var Gy = f, Wy = i, Xy = p, Yy = r, Uy = /^(min|max)?(.+)$/;
    ws.prototype = {
        constructor: ws, setOption: function (t, e) {
            t && f(Ki(t.series), function (t) {
                t && t.data && I(t.data) && E(t.data)
            }), t = Wy(t);
            var n = this._optionBackup, i = bs.call(this, t, e, !n);
    ...
    var qy = f, jy = S, Zy = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
        Ky = function (t, e) {
        ...
        }, $y = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
    ...
    var n_ = {
        ...
        objectRows: {pure: !0, count: Vs, getItem: Hs, appendData: Gs},
        keyedColumns: {
            pure: !0, count: function () {
        ...
        arrayRows: Ws, objectRows: function (t, e, n, i) {
            return null != n ? t[i] : t
        }, keyedColumns: Ws, original: function (t, e, n) {
            var i = Qi(t);
        ...
        getDataParams: function (t, e) {
            var n = this.getData(e), i = this.getRawValue(t, e), r = n.getRawIndex(t), a = n.getName(t),
                ...
                u = this.ecModel.getComponent("tooltip"), h = u && u.get("renderMode"), c = hr(h), d = this.mainType,
            ...
            return {
                ...
                marker: Fo({color: s, renderMode: c}),
    ...
    var u_ = ar(), h_ = Sy.extend({
        ...
        init: function (t, e, n) {
            this.seriesIndex = this.componentIndex, this.dataTask = js({
                count: tl,
                reset: el
            }), this.dataTask.context = {model: this}, this.mergeDefaultAndTheme(t, n), ns(this);
            var i = this.getInitialData(t, n);
            il(i, this), this.dataTask.context.data = i, u_(this).dataBeforeProcessed = i, Qs(this)
        },
        mergeDefaultAndTheme: function (t, e) {
            var n = this.layoutMode, i = n ? jo(t) : {}, a = this.subType;
        ...
        fillDataTextStyle: function (t) {
            if (t && !I(t)) for (var e = ["show"], n = 0; n < t.length; n++) t[n] && t[n].label && $i(t[n], "label", e)
        },
        ...
        formatTooltip: function (t, e, n, i) {
                ...
                function r(t, n) {
                    ...
                    if (r && r.otherDims.tooltip !== !1) {
                        var d = r.type, f = "sub" + o.seriesIndex + "at" + h,
                            p = Fo({color: y, type: "subItem", renderMode: i, markerId: f}),
            ...
            function a(t) {
                return {renderMode: i, content: zo(Bo(t)), style: u}
            }
            ...
            var _ = p > 1 || m && !p ? r(v) : a(p ? Us(c, t, d[0]) : m ? v[0] : v), w = _.content,
                b = o.seriesIndex + "at" + h, M = Fo({color: y, type: "item", renderMode: i, markerId: b});
            u[b] = y, ++h;
            var I = c.getName(t), T = this.name;
            nr(this) || (T = ""), T = T ? zo(T) + (e ? ": " : s) : "";
            var C = "string" == typeof M ? M : M.content, D = e ? C + T + w : T + C + (I ? zo(I) + ": " + w : w);
        ...
        getColorFromPalette: function (t, e, n) {
            var i = this.ecModel, r = Cy.getColorFromPalette.call(this, t, e, n);
    ...
    c_.prototype = {
        constructor: c_, init: function () {
        }, render: function () {
        }, dispose: function () {
        }, filterForExposedEvent: null
    };
    var d_ = c_.prototype;
    d_.updateView = d_.updateLayout = d_.updateVisual = function () {
    }, fr(c_), mr(c_, {registerWhenExtend: !0});
    var f_ = function () {
        var t = ar();
        return function (e) {
    ...
    v_.updateView = v_.updateLayout = v_.updateVisual = function (t, e, n, i) {
        this.render(t, e, n, i)
    }, fr(ol, ["dispose"]), mr(ol, {registerWhenExtend: !0}), ol.markUpdateMethod = function (t, e) {
        p_(t).updateMethod = e
    };
    var m_ = {
    ...
    }, y_ = "\x00__throttleOriginMethod", __ = "\x00__throttleRate", x_ = "\x00__throttleType", w_ = {
        createOnAllSeries: !0, performRawSeries: !0, reset: function (t, e) {
            var n = t.getData(), i = (t.visualColorAccessPath || "itemStyle.color").split("."), r = t.get(i),
            ...
            if (n.setVisual("borderColor", s), !e.isSeriesFiltered(t)) {
                ...
                var l = function (t, e) {
                    var n = t.getItemModel(e), r = n.get(i, !0), a = n.get(o, !0);
        ...
        var n = new Cm({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4}), i = new Lm({
            shape: {startAngle: -M_ / 2, endAngle: -M_ / 2 + .1, r: 10},
        ...
        i.animateShape(!0).when(1e3, {endAngle: 3 * M_ / 2}).start("circularInOut"), i.animateShape(!0).when(1e3, {startAngle: 3 * M_ / 2}).delay(300).start("circularInOut");
        var a = new tg;
    ...
    T_.restoreData = function (t, e) {
        ...
        pl(this, this._dataProcessorHandlers, t, e, {block: !0})
    ...
    var L_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
        O_ = {
            ...
            return {
                axisLine: {lineStyle: {color: B_}},
                axisTick: {lineStyle: {color: B_}},
                axisLabel: {textStyle: {color: B_}},
                splitLine: {lineStyle: {type: "dashed", color: "#aaa"}},
                splitArea: {areaStyle: {color: B_}}
            }
        },
        ...
        R_ = {
            ...
            timeline: {
                lineStyle: {color: B_},
                itemStyle: {normal: {color: z_[1]}},
                label: {normal: {textStyle: {color: B_}}},
                controlStyle: {normal: {color: B_, borderColor: B_}}
            },
            timeAxis: E_(),
            logAxis: E_(),
            valueAxis: E_(),
    ...
    var V_ = {
            g: function (t, e) {
                ...
                var r = t.getAttribute("dx") || 0, a = t.getAttribute("dy") || 0, o = new tg;
        ...
        }, W_ = /url\(\s*#(.*?)\)/, X_ = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g,
        Y_ = /([^\s:;]+)\s*:\s*([^:;]+)/g, U_ = N(), q_ = {
        ...
        }, Z_ = O, K_ = f, $_ = w, Q_ = S, J_ = Sy.parseClassType, tx = "4.6.0", ex = {zrender: "4.2.0"}, nx = 1, ix = 1e3,
        rx = 800, ax = 900, ox = 5e3, sx = 1e3, lx = 1100, ux = 2e3, hx = 3e3, cx = 3500, dx = 4e3, fx = 5e3, px = {
        ...
        }, gx = "__flagInMainProcess", vx = "__optionUpdated", mx = /^[a-zA-Z0-9_]+$/;
    ...
    yx._onframe = function () {
        if (!this._disposed) {
            ...
            if (this[vx]) {
                ...
                var n = nx, i = this._model, r = this._api;
                t.unfinished = !1;
                do {
                    var a = +new Date;
        ...
        if (!this._disposed) {
            ...
            if (Q_(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[gx] = !0, !this._model || e) {
                var r = new ws(this._api), a = this._theme, o = this._model = new Fy;
                o.scheduler = this._scheduler, o.init(null, null, a, r)
            }
            this._model.setOption(t, Ix), n ? (this[vx] = {silent: i}, this[gx] = !1) : (Gl(this), _x.update.call(this), this._zr.flush(), this[vx] = !1, this[gx] = !1, Ul.call(this, i), ql.call(this, i))
        }
        ...
        if (!this._disposed && Hf.canvasSupported) {
            ...
            if (Px[e]) {
                ...
                return t.connectedBackgroundColor && v.add(new Cm({
                    ...
                    var e = new Mi({style: {x: t.left * c - o, y: t.top * c - s, image: t.dom}});
                    v.add(e)
        ...
        var n = this._model;
        t = or(n, t, {defaultMainType: "series"});
    ...
    var _x = {
        prepareAndUpdate: function (t) {
            ...
            var e = this._model;
            e && (ol.markUpdateMethod(t, "updateView"), Kl(e), this._scheduler.performVisualTasks(e, t, {setDirty: !0}), $l(this, this._model, this._api, t), tu(e, this._api))
    ...
    yx.resize = function (t) {
        ...
        if (!this._disposed && (Q_(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), Ax[t])) {
            var n = Ax[t](this._api, e), i = this._zr;
        ...
        if (!this._disposed && (Q_(e) || (e = {silent: !!e}), bx[t.type] && this._model)) {
    ...
    yx._initEvents = function () {
        ...
        constructor: au, normalizeQuery: function (t) {
            var e = {}, n = {}, i = {};
            if (b(t)) {
                var r = J_(t);
    ...
    var bx = {}, Sx = {}, Mx = [], Ix = [], Tx = [], Cx = [], Dx = {}, Ax = {}, kx = {}, Px = {}, Lx = new Date - 0,
        Ox = new Date - 0, Bx = "_echarts_instance_", Ex = uu;
    wu(ux, w_), pu(Jy), gu(ax, t_), Su("default", I_), mu({
        type: "highlight",
        event: "highlight",
        update: "highlight"
    }, V), mu({type: "downplay", event: "downplay", update: "downplay"}, V), fu("light", O_), fu("dark", R_);
    var zx = {};
    Lu.prototype = {
    ...
    var Rx = N(["tooltip", "label", "itemName", "itemId", "seriesName"]), Nx = S, Fx = "undefined", Vx = -1,
        Hx = "e\x00\x00", Gx = {
            ...
            number: Array,
            time: Array
        }, Wx = typeof Uint32Array === Fx ? Array : Uint32Array, Xx = typeof Int32Array === Fx ? Array : Int32Array,
        ...
        qx = ["_extent", "_approximateExtent", "_rawExtent"], jx = function (t, e) {
            t = t || ["x", "y"];
            for (var n = {}, i = [], r = {}, a = 0; a < t.length; a++) {
                var o = t[a];
                b(o) ? o = new Nu({name: o}) : o instanceof Nu || (o = new Nu(o));
                var s = o.name;
    ...
    Zx.type = "list", Zx.hasItemOption = !0, Zx.getDimension = function (t) {
        ...
        if (Nx(t)) for (var n in t) t.hasOwnProperty(n) && this.setVisual(n, t[n]); else this._visual = this._visual || {}, this._visual[t] = e
    }, Zx.setLayout = function (t, e) {
        if (Nx(t)) for (var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]); else this._layout[t] = e
        ...
        if (this._itemVisuals[t] = i, Nx(e)) for (var a in e) e.hasOwnProperty(a) && (i[a] = e[a], r[a] = !0); else i[e] = n, r[e] = !0
    ...
    hh.prototype.parse = function (t) {
        ...
        this._isBlank = t
    }, hh.prototype.getLabel = null, fr(hh), mr(hh, {registerWhenExtend: !0}), ch.createByAxisModel = function (t) {
        var e = t.option, n = e.data, i = n && p(n, fh);
        return new ch({categories: i, needCollect: !i, deduplication: e.dedplication !== !1})
    };
    var Jx = ch.prototype;
    ...
    var tw = hh.prototype, ew = hh.extend({
        type: "ordinal", init: function (t, e) {
            (!t || x(t)) && (t = new ch({categories: t})), this._ordinalMeta = t, this._extent = e || [0, t.categories.length - 1]
        }, parse: function (t) {
    ...
    var nw = _o, iw = _o, rw = hh.extend({
        type: "interval", _interval: 0, _intervalPrecision: 2, setExtent: function (t, e) {
            ...
            for (var s = i[0]; s <= i[1] && (a.push(s), s = iw(s + e, r), s !== a[a.length - 1]);) if (a.length > o) return [];
    ...
    var aw = "__ec_stack_", ow = .5, sw = "undefined" != typeof Float32Array ? Float32Array : Array, lw = {
            seriesType: "bar", plan: f_(), reset: function (t) {
                function e(t, e) {
                ...
                if (Th(t) && Ch(t)) {
                    var n = t.getData(), i = t.coordinateSystem, r = i.getBaseAxis(), a = i.getOtherAxis(r),
                        ...
                        h = Mh(bh([t]), r, t).width;
                    return h > ow || (h = ow), {progress: e}
                }
            }
        }, uw = rw.prototype, hw = Math.ceil, cw = Math.floor, dw = 1e3, fw = 60 * dw, pw = 60 * fw, gw = 24 * pw,
        vw = function (t, e, n, i) {
            for (; i > n;) {
                var r = n + i >>> 1;
                t[r][1] < e ? n = r + 1 : i = r
            ...
            type: "time", getLabel: function (t) {
                ...
                var o = yw.length, s = vw(yw, a, 0, o), l = yw[Math.min(s, o - 1)], u = l[1];
                if ("year" === l[0]) {
                    var h = r / u, c = ko(h / t, !0);
                    u *= c
                }
    ...
    var yw = [["hh:mm:ss", dw], ["hh:mm:ss", 5 * dw], ["hh:mm:ss", 10 * dw], ["hh:mm:ss", 15 * dw], ["hh:mm:ss", 30 * dw], ["hh:mm\nMM-dd", fw], ["hh:mm\nMM-dd", 5 * fw], ["hh:mm\nMM-dd", 10 * fw], ["hh:mm\nMM-dd", 15 * fw], ["hh:mm\nMM-dd", 30 * fw], ["hh:mm\nMM-dd", pw], ["hh:mm\nMM-dd", 2 * pw], ["hh:mm\nMM-dd", 6 * pw], ["hh:mm\nMM-dd", 12 * pw], ["MM-dd\nyyyy", gw], ["MM-dd\nyyyy", 2 * gw], ["MM-dd\nyyyy", 3 * gw], ["MM-dd\nyyyy", 4 * gw], ["MM-dd\nyyyy", 5 * gw], ["MM-dd\nyyyy", 6 * gw], ["week", 7 * gw], ["MM-dd\nyyyy", 10 * gw], ["week", 14 * gw], ["week", 21 * gw], ["month", 31 * gw], ["week", 42 * gw], ["month", 62 * gw], ["week", 70 * gw], ["quarter", 95 * gw], ["month", 31 * gw * 4], ["month", 31 * gw * 5], ["half-year", 380 * gw / 2], ["month", 31 * gw * 8], ["month", 31 * gw * 10], ["year", 380 * gw]];
    mw.create = function (t) {
        return new mw({useUTC: t.ecModel.get("useUTC")})
    };
    var _w = hh.prototype, xw = rw.prototype, ww = bo, bw = _o, Sw = Math.floor, Mw = Math.ceil, Iw = Math.pow,
        Tw = Math.log, Cw = hh.extend({
            ...
            }, getMinorTicks: xw.getMinorTicks, getLabel: xw.getLabel, scale: function (t) {
                return t = _w.scale.call(this, t), Iw(this.base, t)
            }, setExtent: function (t, e) {
                var n = this.base;
                t = Tw(t) / Tw(n), e = Tw(e) / Tw(n), xw.setExtent.call(this, t, e)
            }, getExtent: function () {
                var t = this.base, e = _w.getExtent.call(this);
    ...
    var Dw = {
        ...
        }), Ow = {line: Am, rect: Cm, roundRect: Cm, square: Cm, circle: vm, diamond: kw, pin: Pw, arrow: Lw, triangle: Aw},
        Bw = {
    ...
    }), Rw = {isDimensionStacked: ah, enableDataStack: rh, getStackedDimension: oh}, Nw = (Object.freeze || Object)({
        createList: Wh,
        getLayoutRect: Uo,
        dataStack: Rw,
        createScale: Xh,
    ...
    jh.prototype = {
        constructor: jh, properties: null, getBoundingRect: function () {
            var t = this._rect;
            if (t) return t;
            ...
            n ? i || (i = n / a) : n = a * i;
            for (var o = new Sn(t, e, n, i), s = r.calculateTransform(o), l = this.geometries, u = 0; u < l.length; u++) if ("polygon" === l[u].type) {
    ...
    Ww.prototype = {
        constructor: Ww, contain: function (t) {
            ...
            t = t || {};
            var e = t.tickModel || this.getTickModel(), n = Qh(this, e), i = n.ticks, r = p(i, function (t) {
            ...
            e > 0 && 100 > e || (e = 5);
            var n = this.scale.getMinorTicks(e), i = p(n, function (t) {
                return p(t, function (t) {
                    return {coord: this.dataToCoord(t), tickValue: t}
                }, this)
            }, this);
    ...
    qw.prototype = {
        constructor: qw, type: "cartesian", getAxis: function (t) {
            return this._axes[t]
        }, getAxes: function () {
        ...
        constructor: pc, type: "cartesian2d", dimensions: ["x", "y"], getBaseAxis: function () {
            ...
            var t = this.getAxis("x").getGlobalExtent(), e = this.getAxis("y").getGlobalExtent(),
                ...
                a = Math.max(e[0], e[1]) - i, o = new Sn(n, i, r, a);
            return o
        }
    }, h(pc, qw);
    ...
    jw.prototype = {
        constructor: jw, index: 0, getAxesOnZeroOf: null, model: null, isHorizontal: function () {
            var t = this.position;
    ...
    }, Zw), Kw.timeAxis = s({scale: !0, min: "dataMin", max: "dataMax"}, Kw.valueAxis), Kw.logAxis = s({
        scale: !0,
        logBase: 10
    }, Kw.valueAxis);
    var $w = ["value", "category", "time", "log"], Qw = function (t, e, n, i) {
        f($w, function (o) {
            e.extend({
                type: t + "Axis." + o, mergeDefaultAndTheme: function (e, i) {
                    var a = this.layoutMode, s = a ? jo(e) : {}, l = i.getTheme();
        ...
        function n(n) {
            return function (o, s) {
                if (vc(o, t, e)) {
                    ...
                    var u = new jw(n, Oh(o), [0, 0], o.get("type"), l), h = "category" === u.type;
    ...
    mc.create = function (t, e) {
        ...
        return t.eachComponent("grid", function (i, r) {
            ...
            if (bc(e)) {
                var n = wc(e, t), i = n[0], r = n[1], a = i.getCoordSysModel(), o = a.coordinateSystem;
    ...
    var rb = lv([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["stroke", "barBorderColor"], ["lineWidth", "barBorderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]),
        ab = {
        ...
        }), sb = ["itemStyle", "barBorderWidth"], lb = [0, 0];
    o(uo.prototype, ab), Cu({
        type: "bar", render: function (t, e, n) {
            ...
            var s = t.isAnimationEnabled() ? t : null, l = t.get("clip", !0), u = Ac(a, i);
            n.removeClipPath();
            var h = t.get("roundCap", !0);
            i.diff(r).add(function (r) {
                if (i.hasValue(r)) {
                    var o = i.getItemModel(r), c = fb[a.type](i, r, o);
                    if (l) {
                        var d = cb[a.type](u, c);
                ...
                var f = i.getItemModel(o), p = fb[a.type](i, o, f);
                if (l) {
                    var g = cb[a.type](u, p);
                    if (g) return void n.remove(d)
                }
                d ? Ka(d, {shape: p}, s, o) : d = db[a.type](o, p, e, s, !0, h), i.setItemGraphicEl(o, d), n.add(d), Oc(d, i, o, f, p, t, e, "polar" === a.type)
            }).remove(function (t) {
    ...
    var ub = Math.max, hb = Math.min, cb = {
        ...
        cartesian2d: function (t, e, n, i, r) {
            var a = new Cm({shape: o({}, e)});
            if (i) {
                var s = a.shape, l = n ? "height" : "width", u = {};
                s[l] = 0, u[l] = e[l], Qm[r ? "updateProps" : "initProps"](a, {shape: u}, i, t)
            }
            return a
        }, polar: function (t, e, n, i, r, a) {
            var o = e.startAngle < e.endAngle, l = !n && a ? ob : _m, u = new l({shape: s({clockwise: o}, e)});
            if (i) {
                var h = u.shape, c = n ? "r" : "endAngle", d = {};
                h[c] = n ? 0 : e.startAngle, d[c] = e[c], Qm[r ? "updateProps" : "initProps"](u, {shape: d}, i, t)
            }
            return u
        }
    }, fb = {
        cartesian2d: function (t, e, n) {
            var i = t.getItemLayout(e), r = Bc(n, i), a = i.width > 0 ? 1 : -1, o = i.height > 0 ? 1 : -1;
        ...
        var e = this, n = zc(e, t.offsetX, t.offsetY);
        e.dataIndex = n >= 0 ? n : null
    }, 30, !1), vb = Math.PI, mb = function (t, e) {
        ...
        var n = new tg({position: e.position.slice(), rotation: e.rotation});
        n.updateTransform(), this._transform = n.transform, this._dumbGroup = n
    };
    mb.prototype = {
        constructor: mb, hasBuilder: function (t) {
            return !!yb[t]
        }, add: function (t) {
            yb[t].call(this)
        }, getGroup: function () {
    ...
    var yb = {
        axisLine: function () {
            ...
            var t = this.axisModel, e = this.opt, n = Xc(this, t, e), i = Uc(this, t, e);
            ...
            if (n) {
                ...
                var p = s.getFont(), g = e.get("nameTruncate", !0) || {}, v = g.ellipsis,
                    ...
                    y = null != v && null != m ? gy(n, m, p, v, {minChar: 2, placeholder: g.placeholder}) : n,
    ...
    var Tb = ["axisLine", "axisTickLabel", "axisName"], Cb = ["splitArea", "splitLine", "minorSplitLine"],
        Db = Mb.extend({
            type: "cartesianAxis", axisPointerClass: "CartesianAxisPointer", render: function (t, e, n, i) {
                ...
                if (this._axisGroup = new tg, this.group.add(this._axisGroup), t.get("show")) {
                    var a = t.getCoordSysModel(), o = od(a, t), s = new mb(t, o);
                ...
                var n = t.axis, i = t.getModel("minorSplitLine"), r = i.getModel("lineStyle"),
                    a = e.coordinateSystem.getRect(), o = n.isHorizontal(), s = n.getMinorTicksCoords();
    ...
    var Ab = sd.prototype, kb = sd.getSymbolSize = function (t, e) {
        var n = t.getItemVisual(e, "symbolSize");
        return n instanceof Array ? n.slice() : [+n, +n]
    };
    Ab._createSymbol = function (t, e, n, i, r) {
        this.removeAll();
        var a = e.getItemVisual(n, "color"), o = Gh(t, -1, -1, 2, 2, a, r);
        o.attr({z2: 100, culling: !0, scale: ld(i)}), o.drift = ud, this._symbolType = t, this.add(o)
        ...
        this.silent = !1;
        var i = t.getItemVisual(e, "symbol") || "circle", r = t.hostModel, a = kb(t, e), o = i !== this._symbolType;
        if (o) {
        ...
        if (this._updateCommon(t, e, a, n), o) {
            ...
            u && (h.style = {opacity: l.style.opacity}), l.scale = [0, 0], u && (l.style.opacity = 0), $a(l, h, r, e)
        }
        this._seriesModel = r
    };
    var Pb = ["itemStyle"], Lb = ["emphasis", "itemStyle"], Ob = ["label"], Bb = ["emphasis", "label"];
    ...
    Eb.updateData = function (t, e) {
        e = fd(e);
        var n = this.group, i = t.hostModel, r = this._data, a = this._symbolCtor, o = pd(t);
        r || n.removeAll(), t.diff(r).add(function (i) {
            ...
            return dd(t, h, s, e) ? (u ? (u.updateData(t, s, o), Ka(u, {position: h}, i)) : (u = new a(t, s), u.attr("position", h)), n.add(u), void t.setItemGraphicEl(s, u)) : void n.remove(u)
        }).remove(function (t) {
            var e = r.getItemGraphicEl(t);
    ...
    var zb = function (t, e, n, i, r, a, o, s) {
        ...
        buildPath: function (t, e) {
            var n = e.points, i = e.stackedOnPoints, r = 0, a = n.length, o = e.smoothMonotone,
                s = Sd(n, e.smoothConstraint), l = Sd(i, e.smoothConstraint);
            if (e.connectNulls) {
                for (; a > 0 && _d(n[a - 1]); a--) ;
                for (; a > r && _d(n[r]); r++) ;
            }
    ...
    ol.extend({
        type: "line", init: function () {
            ...
            var i = t.coordinateSystem, r = this.group, a = t.getData(), o = t.getModel("lineStyle"),
                ...
                v = t.get("animation"), m = !l.isEmpty(), y = l.get("origin"), _ = gd(i, a, y), x = Td(i, a, _),
                w = t.get("showSymbol"), b = w && !h && Ad(t, a, i), S = this._data;
            ...
            i && i.getArea && t.get("clip", !0) && (M = i.getArea(), null != M.width ? (M.x -= .1, M.y -= .1, M.width += .2, M.height += .2) : M.r0 && (M.r0 -= .5, M.r1 += .5)), this._clipShapeForSymbol = M, f && c.type === i.type && I === this._step ? (m && !p ? p = this._newPolygon(u, x, i, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Pd(i, !1, t)), w && d.updateData(a, {
                ...
                t.stopAnimation(!0)
            }), Md(this._stackedOnPoints, x) && Md(this._points, u) || (v ? this._updateAnimation(a, x, i, n, I, y) : (I && (u = Cd(u, i, I), x = Cd(x, i, I)), f.setShape({points: u}), p && p.setShape({
                points: u,
                stackedOnPoints: x
            })))) : (w && d.updateData(a, {
                isIgnore: b,
            ...
            var o = this._polyline, s = this._polygon, l = t.hostModel,
                u = zb(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, a), h = u.current,
                c = u.stackedOnCurrent, d = u.next, f = u.stackedOnNext;
            r && (h = Cd(u.current, n, r), c = Cd(u.stackedOnCurrent, n, r), d = Cd(u.next, n, r), f = Cd(u.stackedOnNext, n, r)), o.shape.__points = u.current, o.shape.points = h, Ka(o, {shape: {points: d}}, l), s && (s.setShape({
                points: h,
                stackedOnPoints: c
            }), Ka(s, {shape: {points: d, stackedOnPoints: f}}, l));
    ...
    var Ub = function (t, e, n) {
        ...
        return {
            seriesType: t, plan: f_(), reset: function (t) {
                function e(t, e) {
                ...
                if (i) {
                    ...
                    return ah(n, o[0]) && (o[0] = l), ah(n, o[1]) && (o[1] = l), s && {progress: e}
                }
            }
        }
    }, jb = {
    ...
    var $b = function (t, e, n) {
        ...
        var i = t.getSource(), r = $x(i, e), a = new jx(r, t);
        ...
        getInitialData: function () {
            return $b(this, {coordDimensions: ["value"], encodeDefaulter: _(ls, this)})
        },
        ...
        getDataParams: function (t) {
            var e = this.getData(), n = Jb.superCall(this, "getDataParams", t), i = [];
    ...
    tS.updateData = function (t, e, n) {
        var i = this.childAt(0), r = this.childAt(1), a = this.childAt(2), l = t.hostModel, u = t.getItemModel(e),
        ...
        if (n) {
            ...
            "scale" === f ? (i.shape.r = h.r0, $a(i, {shape: {r: h.r}}, l, e)) : (i.shape.endAngle = h.startAngle, Ka(i, {shape: {endAngle: h.endAngle}}, l, e))
        } else "expansion" === d ? i.setShape(c) : Ka(i, {shape: c}, l, e);
        ...
        this._updateLabel(t, e, v), this.highDownOnUpdate = u.get("hoverAnimation") && l.isAnimationEnabled() ? function (t, e) {
            "emphasis" === e ? (r.ignore = r.hoverIgnore, a.ignore = a.hoverIgnore, i.stopAnimation(!0), i.animateTo({shape: {r: h.r + l.get("hoverOffset")}}, 300, "elasticOut")) : (r.ignore = r.normalIgnore, a.ignore = a.normalIgnore, i.stopAnimation(!0), i.animateTo({shape: {r: h.r}}, 300, "elasticOut"))
        } : null, Ba(this)
        ...
        n ? (Ka(i, {shape: h}, a, e), Ka(r, {style: c}, a, e)) : (i.attr({shape: h}), r.attr({style: c})), r.attr({
            rotation: l.rotation,
            origin: [l.x, l.y],
            z2: 10
        });
        ...
        type: "pie", init: function () {
            ...
            if (!i || i.from !== this.uid) {
                var r = t.getData(), a = this._data, o = this.group, s = e.get("animation"), l = !a,
                    u = t.get("animationType"), h = t.get("animationTypeUpdate"), c = _(Od, this.uid, t, s, n),
            ...
            var l = new _m({shape: {cx: t, cy: e, r0: 0, r: n, startAngle: i, endAngle: i, clockwise: r}}),
                u = s ? $a : Ka;
            return u(l, {shape: {endAngle: i + (r ? 1 : -1) * Math.PI * 2}}, o, a), l
    ...
    }, iS = Math.PI / 180, rS = function (t, e, n, i, r, a) {
        var o, s, l = t.getData(), u = [], h = !1, c = (t.get("minShowLabelAngle") || 0) * iS;
        l.each(function (i) {
            var a = l.getItemLayout(i), d = l.getItemModel(i), f = d.getModel("label"),
                p = f.get("position") || d.get("emphasis.label.position"), g = f.get("distanceToLabelLine"),
                v = f.get("alignTo"), m = yo(f.get("margin"), n), y = f.get("bleedMargin"), _ = f.getFont(),
                x = d.getModel("labelLine"), w = x.get("length");
            w = yo(w, n);
            var b = x.get("length2");
            if (b = yo(b, n), !(a.angle < c)) {
                var S, M, I, T, C = (a.startAngle + a.endAngle) / 2, D = Math.cos(C), A = Math.sin(C);
                o = a.cx, s = a.cy;
                var k = t.getFormattedLabel(i, "normal") || l.getName(i), P = Gn(k, _, T, "top"),
                    L = "inside" === p || "inner" === p;
                if ("center" === p) S = a.cx, M = a.cy, T = "center"; else {
                    var O = (L ? (a.r + a.r0) / 2 * D : a.r * D) + o, B = (L ? (a.r + a.r0) / 2 * A : a.r * A) + s;
                    if (S = O + 3 * D, M = B + 3 * A, !L) {
                        var E = O + D * (w + e - a.r), z = B + A * (w + e - a.r), R = E + (0 > D ? -1 : 1) * b, N = z;
                        S = "edge" === v ? 0 > D ? r + m : r + n - m : R + (0 > D ? -g : g), M = N, I = [[O, B], [E, z], [R, N]]
                    }
    ...
    }, aS = 2 * Math.PI, oS = Math.PI / 180, sS = function (t, e, n) {
        e.eachSeriesByType(t, function (t) {
            var e = t.getData(), i = e.mapDimension("value"), r = Fd(t, n), a = t.get("center"), o = t.get("radius");
            x(o) || (o = [0, o]), x(a) || (a = [a, a]);
            var s = yo(r.width, n.getWidth()), l = yo(r.height, n.getHeight()), u = Math.min(s, l),
                h = yo(a[0], s) + r.x, c = yo(a[1], l) + r.y, d = yo(o[0], u / 2), f = yo(o[1], u / 2),
                p = -t.get("startAngle") * oS, g = t.get("minAngle") * oS, v = 0;
            e.each(i, function (t) {
                !isNaN(t) && v++
            });
            var m = e.getSum(i), y = Math.PI / (m || v) * 2, _ = t.get("clockwise"), w = t.get("roseType"),
                b = t.get("stillShowZeroSum"), S = e.getDataExtent(i);
            S[0] = 0;
            var M = aS, I = 0, T = p, C = _ ? 1 : -1;
        ...
        type: "title", render: function (t, e, n) {
            if (this.group.removeAll(), t.get("show")) {
                var i = this.group, r = t.getModel("textStyle"), a = t.getModel("subtextStyle"), o = t.get("textAlign"),
                    s = A(t.get("textBaseline"), t.get("textVerticalAlign")), l = new gm({
                        style: Va({}, r, {text: t.get("text"), textFill: r.getTextColor()}, {disableBox: !0}),
                        z2: 10
                    }), u = l.getBoundingRect(), h = t.get("subtext"), c = new gm({
                        style: Va({}, a, {
                            text: h,
                ...
                var m = Uo(v, {width: n.getWidth(), height: n.getHeight()}, t.get("padding"));
    ...
    var uS = b_.legend.selector,
        hS = {all: {type: "all", title: i(uS.all)}, inverse: {type: "inverse", title: i(uS.inverse)}}, cS = Mu({
            type: "legend.plain",
            dependencies: ["series"],
            layoutMode: {type: "box", ignoreSize: !0},
            init: function (t, e, n) {
            ...
            _updateSelector: function (t) {
                ...
                e === !0 && (e = t.selector = ["all", "inverse"]), x(e) && f(e, function (t, n) {
                    b(t) && (t = {type: t}), e[n] = r(t, hS[t.type])
                })
            },
            optionUpdated: function () {
            ...
            _updateData: function (t) {
                ...
                t.eachRawSeries(function (i) {
                    ...
                    if (i.legendVisualProvider) {
                        var o = i.legendVisualProvider, s = o.getAllNames();
                ...
                var i = this.get("data") || e, r = p(i, function (t) {
                    return ("string" == typeof t || "number" == typeof t) && (t = {name: t}), new uo(t, this, this.ecModel)
                }, this);
                this._data = r
            },
            getData: function () {
    ...
    var dS = _, fS = f, pS = tg, gS = Iu({
        type: "legend.plain", newlineDisabled: !1, init: function () {
            ...
            if (this._isFirstRender = !1, this.resetInner(), t.get("show", !0)) {
                ...
                var u = t.getBoxLayoutParams(), h = {width: n.getWidth(), height: n.getHeight()}, c = t.get("padding"),
                    d = Uo(u, h, c), f = this.layoutInner(t, r, d, i, o, l),
                    p = Uo(s({width: f.width, height: f.height}, u), h, c);
            ...
            n.eachRawSeries(function (t) {
                ...
                var o = r.get("name");
                if (!this.newlineDisabled && ("" === o || "\n" === o)) return void s.add(new pS({newline: !0}));
            ...
            function i(t) {
                ...
                Na(a.style, a.hoverStyle = {}, o, s, {defaultText: t.title, isRectText: !1}), Ba(a)
            }
            ...
            var c = i.get("itemWidth"), d = i.get("itemHeight"), f = i.get("inactiveColor"),
                ...
                m = i.isSelected(t), y = new pS, _ = n.getModel("textStyle"), x = n.get("icon"),
    ...
    var mS = cS.extend({
    ...
    }), yS = tg, _S = ["width", "height"], xS = ["x", "y"], wS = gS.extend({
        type: "legend.scroll", newlineDisabled: !0, init: function () {
            ...
            function s(t, n) {
                var r = t + "DataIndex",
                    a = ro(e.get("pageIcons", !0)[e.getOrient().name][n], {onclick: y(l._pageGo, l, r, e, i)}, {
                        x: -h[0] / 2,
                        y: -h[1] / 2,
                        width: h[0],
                        height: h[1]
            ...
            var s = this.getSelectorGroup(), l = t.getOrient().index, u = _S[l], h = xS[l], c = _S[1 - l],
                d = xS[1 - l];
            ...
            var h = s.getBoundingRect(), c = u.getBoundingRect(), d = this._showController = h[r] > n[r],
                f = [-h.x, -h.y];
            e || (f[i] = s.position[i]);
            ...
            if (y[r] = d ? n[r] : h[r], y[a] = Math.max(h[a], c[a]), y[o] = Math.min(0, c[o] + g[1 - i]), l.__rectSize = n[r], d) {
                var _ = {x: 0, y: 0};
                _[r] = Math.max(n[r] - c[r] - v, 0), _[a] = y[a], l.setClipPath(new Cm({shape: _})), l.__rectSize = _[r]
            } else u.eachChild(function (t) {
                t.attr({invisible: !0, silent: !0})
            });
            var x = this._getPageInfo(t);
            return null != x.pageIndex && Ka(s, {position: x.contentPosition}, d ? t : !1), this._updatePageInfoView(t, x), y
            ...
            var i = t.get("scrollDataIndex", !0), r = this.getContentGroup(), a = this._containerGroup.__rectSize,
                o = t.getOrient().index, s = _S[o], l = xS[o], u = this._findTargetItemIndex(i), h = r.children(),
    ...
    var bS = function (t, e) {
        ...
        return {point: i, el: s}
    }, SS = f, MS = _, IS = ar(), TS = function (t, e, n) {
        var i = t.currTrigger, r = [t.x, t.y], a = t, o = t.dispatchAction || y(n.dispatchAction, n),
            s = e.getComponent("axisPointer").coordSysAxesInfo;
        if (s) {
            nf(r) && (r = bS({seriesIndex: a.seriesIndex, dataIndex: a.dataIndex}, e).point);
            var l = nf(r), u = a.axesInfo, h = s.axesInfo, c = "leave" === i || nf(r), d = {}, f = {},
                p = {list: [], map: {}}, g = {showPointer: MS(Zd, f), showTooltip: MS(Kd, p)};
            SS(s.coordSysMap, function (t, e) {
                var n = l || t.containPoint(r);
                SS(s.coordSysAxesInfo[e], function (t) {
                    var e = t.axis, i = tf(u, t);
                    if (!c && n && (!u || i)) {
                        var a = i && i.value;
    ...
    cf.prototype = {
        ...
        determineAnimation: function (t, e) {
            ...
            if ("auto" === n || null == n) {
                ...
                if (a) {
                    var s = td(t).seriesDataCount, l = i.getExtent();
        ...
        updateLabelEl: function (t, e, n, i) {
            var r = kS(t).labelEl;
            r && (r.setStyle(e.label.style), n(r, {shape: e.label.shape, position: e.label.position}), pf(r, i))
        },
    ...
    var OS = cf.extend({
        makeElOption: function (t, e, n, i, r) {
            var a = n.axis, o = a.grid, s = i.get("type"), l = If(o, a).getOtherAxis(a).getGlobalExtent(),
                u = a.toGlobalCoord(a.dataToCoord(e, !0));
            if (s && "none" !== s) {
                var h = mf(i), c = BS[s](a, u, l);
                c.style = h, t.graphicKey = c.type, t.pointer = c
            }
            var d = od(o.model, n);
            bf(e, t, d, n, i, r)
        }, getHandleTransform: function (t, e, n) {
            var i = od(e.axis.grid.model, e, {labelInside: !1});
            return i.labelMargin = n.get("handle.margin"), {
                position: wf(e.axis, t, i),
                rotation: i.rotation + (i.labelDirection < 0 ? Math.PI : 0)
            }
        }, updateHandleTransform: function (t, e, n) {
            var i = n.axis, r = i.grid, a = i.getGlobalExtent(!0), o = If(r, i).getOtherAxis(i).getGlobalExtent(),
        ...
        line: function (t, e, n) {
            ...
            return {type: "Rect", shape: Mf([e - i / 2, n[0]], [i, r], Tf(t))}
        }
    };
    ...
    kf.prototype = {
        ...
        constructor: Pf, _enterable: !0, update: function () {
        }, show: function () {
    ...
    var FS = y, VS = f, HS = yo, GS = new Cm({shape: {x: -1, y: -1, width: 2, height: 2}});
    Iu({
        type: "tooltip", init: function (t, e) {
            ...
            if (i.from !== this.uid && !Hf.node) {
                ...
                if (i.tooltip && null != i.x && null != i.y) {
                    ...
                    var s = bS(i, e), l = s.point[0], u = s.point[1];
            ...
            if (null != r && null != a && null != o) {
                ...
                if (s) {
                    var l = s.getData(), t = Lf([l.getItemModel(a), s, (s.coordinateSystem || {}).model, t]);
            ...
            var n = this._ecModel, i = this._tooltipModel, a = [e.offsetX, e.offsetY], o = [], s = [],
                l = Lf([e.tooltipOption, i]), u = this._renderMode, h = this._newLine, c = {};
            VS(t, function (t) {
            ...
            var a = new uo(i, this._tooltipModel, this._ecModel), o = a.get("content"), s = Math.random();
            ...
            if (this._ticket = "", t.get("showContent") && t.get("show")) {
                ...
                o = o || t.get("position");
                var c = e;
                if (h && "string" == typeof h) c = Ro(h, n, !0); else if ("function" == typeof h) {
            ...
            if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([n, i], a, r.el, d, {
                viewSize: [s, l],
                contentSize: u.slice()
            })), x(e)) n = HS(e[0], s), i = HS(e[1], l); else if (S(e)) {
    ...
    }), mu({type: "showTip", event: "showTip", update: "tooltip:manuallyShowTip"}, function () {
    }), mu({type: "hideTip", event: "hideTip", update: "tooltip:manuallyHideTip"}, function () {
